...
public class DateUtilityTest {
    ...
    void 日付の2025年8月1日を渡したら2025年8月1日が返る() throws ParseException {
        String dateString = "2025/08/25 12:00:00";
    ...
    @Test
    void 日付の2025年8月1日を渡したら2025年8月31日が返る() throws ParseException {
        String dateString = "2025/08/25 12:00:00";
        SimpleDateFormat formatter = new SimpleDateFormat("yyyy/MM/dd HH:mm:ss");
        Date date = formatter.parse(dateString);
        Date endDate = DateUtility.createEndDateOfMonth(date);
        //System.out.println(endDate.toString());
        SimpleDateFormat afterFormatter = new SimpleDateFormat("yyyy/MM/dd HH:mm:ss");
        //System.out.println(afterFormatter.format(endDate));
        assertEquals("2025/08/31 23:59:59", afterFormatter.format(endDate));
    }
}
